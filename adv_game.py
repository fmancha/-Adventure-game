...
def intro(villain):
    ...
    print_pause("Rumor has it that a " + villain + " is somewhere around here,"
                " and has been terrifying the nearby village.")  # Random
...
def house(items, villain):
    ...
    print_pause("You are about to knock when the door opens and out steps"
                " a " + villain + ".")  # ad ramdom pirata o troll
    print_pause("Eep! This is the " + villain + " house!")  # ad ramdom
    print_pause("The " + villain + " attacks you!")  # random
...
def play_game():
    items = []
    villains = ['pirate', 'gorgon', 'monster', 'evil clown']
